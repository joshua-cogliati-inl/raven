...
setup(name='raven_cxx',
      ...
      package_dir={'': 'src/contrib', 'crow_modules': 'src/crow_modules'},
      ext_modules=[
          ...
          Extension('_amsc',['src/contrib/amsc.i',
                             'src/contrib/UnionFind.cpp',
                             'src/contrib/AMSC.cpp'],
                    include_dirs=include_dirs, swig_opts=swig_opts,extra_compile_args=extra_compile_args)],
      py_modules=['amsc','crow_modules.distribution1D','crow_modules.randomENG','crow_modules.interpolationND', 'AMSC.AMSC_Object'],
